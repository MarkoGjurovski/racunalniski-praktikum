...
\section{Avtomatizirana izdelava urnik}
...
zato si je smiselno podrobneje ogledati posamezne korake.
   ...
   Za vse proste termine $predavalnice_j$ izračunamo ceno vstavljanja
   $srečanja_i$, ki ga sestavlja $predmet_i$, profesor, ki ta predmet predava,
   ...
   Ko preverimo vse proste termine vseh predavalnic, vstavimo $srečanje_i$
...
spremembo (npr. zamenjava $srečanja_i$ in $srečanja_j$) sedaj shranimo v
